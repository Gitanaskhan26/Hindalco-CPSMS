    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal rounded-full transition-transform hover:scale-105"
        ),
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary/90 focus:bg-primary focus:text-primary-foreground scale-105",
        day_today: "bg-accent/80 text-accent-foreground ring-1 ring-accent",
