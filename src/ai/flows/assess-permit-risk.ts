...
const prompt = ai.definePrompt({
  ...
  Based on the permit description and PPE checklist, determine the risk level of the permit (low, medium, or high) and provide a justification for your assessment.
